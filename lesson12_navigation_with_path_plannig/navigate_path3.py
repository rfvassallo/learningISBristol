...
def navigate(goalX,goalY,robotArUco, worldFrame, mapFile,step,robot_size,N_KNN,MAX_EDGE_LEN,show_path):
    ...
    # Initialise parameters for Path-planning
    #mapFile = "map1311.dat"
    #step = 2
    #robot_size = 0.6
    ...
    try:
        while True:
            ...
            #print(dist)
            # If distance to current goal is less than 20cm, pick the next point in the path to be the next goal
            if dist < 0.2 :
                i = i + 1
                print(dist)
            ...
            # If distance to current goal is greater than 20cm, check if robot is stopped 
