...
def read_map(mapFile,step):
    ...
    with open(mapFile, 'r') as f:
        ...
        for i in range(0,len(x),step):
            lowRes_x.append(x[i])
            lowRes_y.append(y[i])
    return x, y, lowRes_x, lowRes_y
        
        


x,y,lowRes_x,lowRes_y = read_map(mapFile,step)
...
x,y,lowRes_x,lowRes_y = read_map("map1311.dat",step)
plt.plot(lowRes_x,lowRes_y,'r.')
