...
MAX_EDGE_LEN = 3.0  # [m] Maximum edge length
...
def main():
    ...
    for i in range(40):
        ...
        oy.append(60.0 - i)
    ''' 
    for i in frange(-2,4,0.1):
        ox.append(i)
        oy.append(-2)
    for i in frange(-2,18,0.1):
        ox.append(4)
        oy.append(i)
    for i in frange(1,4,0.1):
        ox.append(i)
        oy.append(18)
    for i in frange(15,18,0.1):
        ox.append(1)
        oy.append(i)
    for i in frange(2,15,0.1):
        ox.append(2)
        oy.append(i)
